...
final class PurchaseManager: NSObject ,StoreState {
    private static let label:String = "com.arpple.tistory.HueIn.Plus"
    ...
    private override init() { // 싱글톤으로 구현
        super.init()
